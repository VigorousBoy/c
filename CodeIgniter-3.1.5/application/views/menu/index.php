...
<link rel="stylesheet" href="<?= ROOTPATH; ?>static/css/font-awesome.min.css">
<!-- 自定义样式 -->
<link rel="stylesheet" href="<?= ROOTPATH; ?>static/css/wx-custom.css">
<!--[if lt IE 9]>
...
<script src="<?= ROOTPATH; ?>static/js/jquery-1.11.1.min.js"></script>
<script src="<?= ROOTPATH; ?>static/js/bootstrap.min.js"></script>
<!-- 自定义菜单排序 -->
<script src="<?= ROOTPATH; ?>static/js/Sortable.js"></script>
<script src="<?= ROOTPATH; ?>static/js/menu2.js"></script>
...
08月12日
						...
						<div class="panel-body">
							...
							<div class="msg-img"><img src="<?= ROOTPATH; ?>static/images/20170831595cf16beb634972a65adb6b14abca9b.jpg" alt=""></div>
...
08月31日
						...
						<div class="panel-body">
							...
							<div class="msg-img"><img src="<?= ROOTPATH; ?>static/images/1.png" alt=""></div>
							<p class="msg-text">微信缴费使用指南</p>
						</div>
						<div class="mask-bg"><div class="mask-icon"><i class="icon-ok"></i></div></div>
					</div>
